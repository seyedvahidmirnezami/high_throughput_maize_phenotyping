...
def downsample_flatten1(imagefoldername,maskfoldername,noimage,nchannels,patch_size,img_size):
    ...
    for file in filelist:
        ...
        count=count+1
    return train_input,train_ouput, train_input_name
    

    
# Preprocess the image and flatten     
Xa,Y,train_input_name =downsample_flatten1(inputimagedata,maskedimagedata,num_images,3,patch_size,img_size)
...
test_input_name=train_input_name[:num_test_img];
